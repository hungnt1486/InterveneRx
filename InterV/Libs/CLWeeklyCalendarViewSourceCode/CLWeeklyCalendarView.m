...
static NSInteger const CLCalendarDayTitleTextColorDefault = 0x12465C;//0xC2E8FF;
...
@end
static CLWeeklyCalendarView *_instance;
...
+ (CLWeeklyCalendarView *)ShareInstance{
    return _instance;
}
...
-(UILabel *)dayTitleViewForDate: (NSDate *)date inFrame: (CGRect)frame
{
    ...
    NSLog(@"dayTitleLabel = %@", dayTitleLabel);
